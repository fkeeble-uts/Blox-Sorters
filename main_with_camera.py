...
SAFE_Z_HEIGHT_M = 0.03  # Safe height above the workspace in meters (50mm)
...
def autonomous_pick_and_place(client, cam_x_mm, cam_y_mm, drop_x_mm, drop_y_mm):
    ...
    send_target_end_effector_pose(client, [0.2, 0.01, 0.03], rpy=(0.0, 0.0, 1.8))
    time.sleep(2)
...
def process_blocks_from_json(client):
    ...
    for i, block in enumerate(blocks):
        try:
            ...
            autonomous_pick_and_place(client, cam_x, cam_y, 50, 50)
            time.sleep(4)
